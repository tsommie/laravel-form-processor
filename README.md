...
**This is a package for Laravel and Lumen 5**
...
- [1. Laravel Form Processor](#1-laravel-form-processor)
    - [1.1. Setting up](#11-setting-up)
        - [1.1.1. Installation on Lumen and Laravel 5.5 and above.](#111-installation-on-lumen-and-laravel-55-and-above)
...
## 1.1. Setting up
### 1.1.1. Installation on Lumen and Laravel 5.5 and above.
...
```
After the process has been generated, all the logic that is required to update the `Article published field` will go into the `handle` method.
...
When it comes to where to put your process in a controller it only comes down to what category ur actions fall into in the `CRUD` classification.
